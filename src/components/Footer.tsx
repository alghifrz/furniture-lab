        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-coklat-terang hover:text-white transition-colors">
            ...
            <div>
              ...
              <li>
                <Link href="/categories" className="text-coklat-terang hover:text-white transition-colors">
                  {content.footer.quickLinks.links.categories}
                </Link>
              </li>
              <li>
                <Link href="/feedback" className="text-coklat-terang hover:text-white transition-colors">
                  {content.footer.quickLinks.links.feedback}
                  </Link>
              </li>
            </ul>
          </div>
